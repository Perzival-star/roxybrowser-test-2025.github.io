...
osVersion|string|操作系统版本, 枚举值：Windows的枚举值：11、10、8、7;macOS的枚举值: 15.3.2,15.3.1,15.3,15.2,15.1,15.0.1,15.0,14.7.4,14.7.3,14.7.2,14.7.1,14.7,14.6.1,14.6,14.5,14.4.1,14.4,14.3.1,14.3,IOS的枚举值：18.2、18.1、18.0、17.0、16.6、16.5、16.4、16.3、16.2、16.1、16.0、15.7、15.6、15.5、15.4、15.3、15.2、15.1、15.0、14.7、14.6、14.5、14.4、14.3、14.2、14.1、14.0
...
windowPlatformList|List|见 [windowPlatformList](#section1)
statusInfo|object	|窗口打开时的详细信息，见 [statusInfo](#section2)
proxyInfo|object	|见 [proxyInfo](#section3)
labelInfo|object	|见 [labelInfo](#section4)
msg|string|返回结果
...
```Json
{
    ...
    "fingerInfo": {
        ...
        "startupParam": ""                                      // 浏览器启动参数, str类型，多个参数以英文逗号分隔，非必传
    }
}
```
参数名称|必须项|参数类型|默认值|描述
...
windowPlatformList|否|List|--|见 [windowPlatformList](#section5)
proxyInfo|否|object|--|见 [proxyInfo](#section6)
fingerInfo|否|object|--|见 [fingerInfo](#section7)
...
windowRemark|否|string|--|窗口备注
projectId|否|number|--|项目ID
windowPlatformList|否|List|--|见 [windowPlatformList](#section12)
proxyInfo|否|object|--|见 [proxyInfo](#section13)
fingerInfo|否|object|--|见 [fingerInfo](#section14)
